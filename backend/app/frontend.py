...
search_field = None  # Define search_field as a global variable
results = ui.row()  # Assuming results is a UI element
...
def init(fastapi_app: FastAPI) -> None:
    ...
    def markdown_diff(old_doc, current_doc):
    ...
    def show():
        async def search(e: events.ValueChangeEventArguments) -> None:
            ...
            if not response:
                return
            with results: 
                for topic in response:  # iterate over the response data of the api
